...
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter1_Motivation/motivation_speed_test 1 1 > naiveDSA.txt
...
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter1_Motivation/motivation_speed_test 1 1 > LightDSA.txt

# Finally, we get CPU performance
echo "Running CPU test..."
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter1_Motivation/motivation_speed_test 1 0 > CPU.txt

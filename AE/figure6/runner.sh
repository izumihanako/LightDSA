...
cd ../AE/figure6
echo "Running PRS..."
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter3_2_PF/page_tapping 0 0 > PRS.txt
...
cd ../AE/figure6
echo "Running no PRS..."
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter3_2_PF/page_tapping 0 0 > no_PRS.txt

echo "Running tap all..."
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter3_2_PF/page_tapping 1 0 > tap_all.txt

echo "Running tap demand..."
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter3_2_PF/page_tapping 2 0 > tap_demand.txt

echo "Running tap only..."
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter3_2_PF/page_tapping 3 0 > tap_only.txt

echo "Running tap demand with large page..."
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter3_2_PF/page_tapping 4 0 > tap_demand_large.txt

echo "Running tap only with large page..."
sudo numactl -C0 --membind=0 ../../build/expr/paper/chapter3_2_PF/page_tapping 5 0 > tap_only_large.txt

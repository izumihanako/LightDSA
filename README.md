...
cd AE && ./reproduce.sh 
```
The figures for each experiment will be generated in their corresponding figureX directories (X = 1, 3, 4, 5, 6, 7, 8, 9, 12, 13, 15).
...
<!-- Fugure12 488.82s user 253.78s system 103% cpu 11:54.96 total -->
<!-- Figure13 7m48.626s user 4m8.417s sys 11m30.628s real -->
<!-- Figure14 ./env_init.sh  294.61s user 54.40s system 73% cpu 7:55.88 total
